...
class Directorios(Gtk.TreeView):
    ...
    def __init__(self):
        ...
        self.treeselection.set_select_function(self.__selecciones, self.get_model())
    ...
    def __selecciones(self, treeselection, model, path, is_selected, treestore):
    ...
    def __expandir (self, treeview, iter, path, user_param1):
        ...
        valordelprimerhijoenlafila = self.get_model().get_value(iterdelprimerhijo, 1)
        valor = self.get_model().get_value(iter, 2)
        dir = (valor, path)
