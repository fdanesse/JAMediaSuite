...
class MplayerReproductor(GObject.GObject):
    ...
    def __handle(self):
        ...
        if not self.entrada.closed:
            ...
            #    duracion = float(duracion.split("=")[1]) # en Segundos
            #    print "dur", duracion
            ...
            #    posicion = float(posicion.split("=")[1]) # en Segundos
            #    print "pos", posicion
            ...
            if linea:
                if "ANS_percent_pos" in linea:
                    # Información sobre el porcentaje Reproducido
                    # hasta el momento. Ejemplo:
                    # ANS_percent_pos=0
                    ...
                    # main-office.rautemusik.fm[87.230.101.9]: 80...

                    pass

                elif "Name" in linea:
                    # El nombre de una streaming de Radio. Ejemplo:
                    # Name   : #MUSIK.MAIN - WWW.RAUTEMUSIK.FM - 24H
                    # TOP 40 POP HITS 80S 90S DANCE HOUSE ROCK RNB AND MORE!

                    pass

                elif "Playing" in linea:
                    # La Pista que se está reproduciendo. Ejemplo:
                    # Playing /media/4E432D364BC64012/E - Videos/Tylor
                    # swift/Back to December-Taylor Swift Lyrics.
                    ...
                    # AUDIO: 44100 Hz, 2 ch, s16le, 98.6 kbit/6.99%
                    # (ratio: 12323->176400)
                    # Selected audio codec: [ffaac] afm: ffmpeg
                    ...
                    # (it should be readable by the us"
                    # Unsupported PixelFormat 61"
                    # Unsupported PixelFormat 53"
                    # Unsupported PixelFormat 81"
                    # eo (h264), -vid 0"
                    # [lavf] stream 1: audio (aac), -aid 0"
                    # VIDEO:  [H264]  640x480  0bpp  30.000 fps
                    # 218.3 kbps (26.6 kbyte/s)"
                    # Clip info:"
                    # starttime: 0"
                    # totalduration: 226"
                    # totaldatarate: 338"
                    ...
                    # purl: "
                    # pmsg: "
                    # Load subtitles in /media/4E432D364BC64012/E -
                    # Videos/Tylor swift/"

                    # libavcodec version 53.35.0 (external)"
                    # Mismatching header version 53.32.2"

                    # A:   0.0 V:   0.0 A-V:  0.014 ct:  0.000   0/
                    # 0 ??% ??% ??,?% 0 0 90%"
                    # A: 123.2 V: 123.2 A-V: -0.000 ct:  0.033   0/
                    # 0  2%  1%  0.4% 0 0 50%"

                    # Cuando no se puede Acceder a un Streaming. Ejemplo:"
                    # Failed to get value of property 'percent_pos'."
                    # Failed to get value of property
                    # percent_ANS_ERFailed to get value of"
                    # prANS_ERROR=PROPERTY_UNAFailed
                    # toANS_ERROR=PROPERTY_UNAVAILABLE"
