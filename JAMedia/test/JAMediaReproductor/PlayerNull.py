...
class Player(gobject.GObject):
    ...
    "endfile": (gobject.SIGNAL_RUN_CLEANUP,
        gobject.TYPE_NONE, []),
    "estado": (gobject.SIGNAL_RUN_CLEANUP, gobject.TYPE_NONE,
        (gobject.TYPE_STRING,)),
    "newposicion": (gobject.SIGNAL_RUN_CLEANUP, gobject.TYPE_NONE,
        (gobject.TYPE_INT,)),
    "volumen": (gobject.SIGNAL_RUN_CLEANUP, gobject.TYPE_NONE,
        (gobject.TYPE_FLOAT,)),
    "video": (gobject.SIGNAL_RUN_CLEANUP, gobject.TYPE_NONE,
