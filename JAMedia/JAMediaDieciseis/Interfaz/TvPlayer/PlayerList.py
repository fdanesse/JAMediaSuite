...
class PlayerList(gtk.Frame):
    ...
    def __load(self, widget, items, tipo):
        if tipo == "load":
            ...
            items = [
                ["Capital Tv", "http://www.capitalfm.com/tv/player/"],
                ["Youtube", "http://www.youtube.com"],
                ["Euro News", "http://es.euronews.com/noticias/en-directo/"],
                ["Telesur", "http://mblive.telesur.ultrabase.net"],
                ["Rusia to day", "http://actualidad.rt.com/en_vivo"],
                ["Deustche Welle", "http://www.dw.com/es/multimedia/tv-en-vivo/s-100837/channel/9797"],
                ["Venezolana de Televisión", "http://www.vtv.gob.ve/en-vivo"],
                ["Canal 12 de Uruguay", "http://www.teledoce.com/envivo/"],
                ["Canal 4 de Uruguay", "http://www.montecarlotv.com.uy/index_1.html"],
...
class Lista(gtk.TreeView):
    ...
    def __ejecutar_agregar_elemento(self, elementos):
        ...
        icono = os.path.join(ICONS, "Household-Tv-icon.png")
