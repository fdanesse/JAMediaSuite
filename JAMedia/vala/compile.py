...
def run():
    comando = "valac --pkg gio-2.0 --pkg libsoup-2.4 --pkg json-glib-1.0 --pkg glib-2.0 --pkg gtk+-3.0 --pkg gdk-3.0 --pkg gdk-x11-3.0 --pkg gstreamer-1.0 --pkg cairo JAMedia.vala"
