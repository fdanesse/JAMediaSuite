...
JToolbar::JToolbar(){
    ...
    lis->set_tooltip_text("Lista Visibles");lis->set_active(true);
    ...
    con->set_tooltip_text("Controles Visibles");con->set_active(true);
    ...
    ful->set_tooltip_text("Pantalla Completa");ful->set_active(false);
...
bool JToolbar::get_view_controls(){return con->get_active();}
bool JToolbar::get_view_list(){return lis->get_active();}
void JToolbar::video(bool val){
    izq->set_sensitive(val); der->set_sensitive(val);}
