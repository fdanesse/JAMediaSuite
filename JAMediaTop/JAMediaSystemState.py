...
def get_memory_free():
    """
    Devuelve la cantidad de Memoria libre
    en el Sistema, en MB.
    """
...
def get_virtual_memory():
    """
    Devuelve el total de memoria virtual
    en el sistema, en MB.
    """
...
def get_process_name(pid):
    """
    Devuelve el nombre de un proceso
    segun pid.
    """
    
    if pid == 0: return 'sched'  # special case for kernel process
...
def get_process_cmdline(pid):
    ...
    if pid == 0: return []   # special case for kernel process
...
def get_process_threads(pid):
    """
    Devuelve los Procesos Hijos de
    un Determinado Proceso segun pid.
    """
...
def get_open_files(pid):
    """
    Devuelve lista de path de archivos
    que mantiene abiertos este proceso.
    """
...
def get_archivos_abiertos_por_proceso(pid):
    """
    Devuelve datos de archivos abiertos por un
