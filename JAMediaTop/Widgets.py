...
class TopView(Gtk.TreeView):
    ...
    def setear_columnas(self):
        ...
        self.append_column(self.construir_columa('Pid', 0, True))
        self.append_column(self.construir_columa('Proceso', 1, True))
        self.append_column(self.construir_columa('Ejecutable', 2, True))
