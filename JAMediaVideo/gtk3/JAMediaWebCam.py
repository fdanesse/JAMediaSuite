...
from JAMediaVideoBins import Efectos_Video_bin
from JAMediaVideoBins import Foto_bin
from JAMediaVideoBins import Vorbisenc_bin
from JAMediaVideoBins import Theoraenc_bin
from JAMediaVideoBins import JAMedia_Camara_bin
...
class JAMediaWebCam(GObject.GObject):
    ...
    def __remover(self, objeto):
        ...
        if objeto in self.pipeline.children:
            self.pipeline.remove(objeto)
...
if __name__ == "__main__":
    ...
    from gi.repository import GdkX11  # necesario
