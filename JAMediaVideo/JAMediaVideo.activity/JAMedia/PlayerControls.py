...
class PlayerControls(gtk.EventBox):
    ...
    def __init__(self):
        ...
        self.pix_play = gtk.gdk.pixbuf_new_from_file_at_size(
            os.path.join(BASE_PATH, "Iconos", "play.svg"), 45, 45)
        self.pix_paused = gtk.gdk.pixbuf_new_from_file_at_size(
            os.path.join(BASE_PATH, "Iconos", "pausa.svg"), 45, 45)

        self.atras = JAMediaToolButton(pixels=45)
        ...
        self.play = JAMediaToolButton(pixels=45)
        ...
        self.siguiente = JAMediaToolButton(pixels=45)
        archivo = os.path.join(BASE_PATH, "Iconos", "siguiente.svg")
        ...
        self.stop = JAMediaToolButton(pixels=45)
