...
class JAMediaVideoConvert(Gtk.Plug):

    __gtype_name__ = 'JAMediaVideoConvert'
    ...
    def __init__(self, origen, codec):
        """
        JAMediaVideoConvert: Gtk.Plug para embeber en otra aplicacion.
        """
